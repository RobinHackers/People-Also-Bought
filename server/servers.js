...
// server1.use(morgan('dev'));
server1.use('/api', cache, router);
...
// server2.use(morgan('dev'));
server2.use('/api', cache, router);
...
// server3.use(morgan('dev'));
server3.use(parser.json());
server3.use('/api', cache, router);
...
// server4.use(morgan('dev'));
server4.use('/api', cache, router);
